...
JOIN AKUZ.T_EVENT_BASE t4 ON t4.EventID = t0.AmbulanceEvent 
JOIN VCLib.T_ENTITIES t17 ON t17.EntityID = t4.type_
JOIN AKUZ.T_AMBULANCE_CARD t18 ON t18.AmbulanceCardID = t4.AmbulanceCard
JOIN AKUZ.T_PATIENT t19 ON t19.PatientID = t18.Patient
JOIN AKUZ.T_LPU_MAIN t20 ON t20.LpuID = t18.CardLpu
JOIN AKUZ.T_POST t5 ON t5.ResourceID = t0.Post
JOIN AKUZ.T_RESOURCE t6 ON t6.ResourceID = t0.Post and t6.type_ in (501)
JOIN AKUZ.T_DIVISION t7 ON t7.DivisionID = t6.Division
JOIN AKUZ.T_BRANCH t8 ON t8.LpuID = t7.Branch
JOIN AKUZ.T_WORKER t22 ON t22.WorkerID = t5.Worker
JOIN AKUZ.T_SPECIALITY t23 ON t23.SpecialityID = t6.Speciality
